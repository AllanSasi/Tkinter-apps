...
nameLabel = tk.Label(root, text="Enter Full Name", width=40, anchor='w',font=("Sylfaen", 12)).grid(row=1, column=0, padx=(10,0),pady=(30, 0))
collegeLabel = tk.Label(root, text="Enter College/University", width=40, anchor='w',font=("Sylfaen", 12)).grid(row=2, column=0, padx=(10,0))
phoneLabel = tk.Label(root, text="Enter Contact Number", width=40, anchor='w',font=("Sylfaen", 12)).grid(row=3, column=0, padx=(10,0))
addressLabel = tk.Label(root, text="Enter Postal Address", width=40, anchor='w',font=("Sylfaen", 12)).grid(row=4, column=0, padx=(10,0))
...
def takeNameInput():
    ...
    try:
        ...
        if ((len(username) ==0) or (len(collegeName) ==0)) or (len(address) ==0):
            messagebox.showerror("Error","Please enter a value")
        else:
            messagebox.showerror("Error","Insert a valid number")
...
displayButton = tk.Button(root, text="Display Stored-Data", command=lambda :destroyRootWindow())
